...
namespace mcsm {
    ...
    public:
         ...
         * Calls `Server#start`.
         */
        mcsm::VoidResult startServer(mcsm::JvmOption& option, const std::string& path, const std::vector<std::string>& cliArgs, const std::string& optionPath);
        
        /**
         * Calls `Server#start`.
         */
        mcsm::VoidResult startServer(mcsm::JvmOption& option, const std::string& path, const std::vector<std::string>& cliArgs, const std::string& optionPath, const std::string& groupOptionPath);
    private:
